...
public class Maininterface extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton1.setLabel("Register Employees");

        jButton2.setLabel("Update Employee");

        jButton3.setLabel("Set Salary");

        jButton4.setLabel("Calculate Salary");

        jButton5.setLabel("View Salary");

        jButton6.setLabel("Role Management");

        jButton7.setLabel("Set Attendance");
